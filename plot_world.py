...
for i in range(x_circle_top_size):
    y_outer_circle_top.append((world.track_len/2) + np.sqrt(world.r_o*world.r_o-x_outer_circle_top[i]*x_outer_circle_top[i]))
    y_inner_circle_top.append((world.track_len / 2) + np.sqrt(world.r_i * world.r_i - x_inner_circle_top[i] * x_inner_circle_top[i]))
    y_outer_circle_bottom.append(-(world.track_len / 2) - np.sqrt(world.r_o * world.r_o - x_outer_circle_top[i] * x_outer_circle_top[i]))
    y_inner_circle_bottom.append(-(world.track_len / 2) - np.sqrt(world.r_i * world.r_i - x_inner_circle_top[i] * x_inner_circle_top[i]))
